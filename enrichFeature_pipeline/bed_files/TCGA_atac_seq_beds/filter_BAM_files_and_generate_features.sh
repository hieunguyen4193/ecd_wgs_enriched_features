...
outputdir="/mnt/DATASM14/DATA_HIEUNGUYEN/outdir/enriched_features_20250928/TCGA_atac_seq_beds";
beddir=${srcdir}/enrichFeature_pipeline/bed_files/TCGA_atac_seq_beds
